...
# 이미지 로딩
imgTitle = pygame.image.load("image_file/title.png")
imgWall = pygame.image.load("image_file/wall.png")
imgWall2 = pygame.image.load("image_file/wall2.png")
imgDark = pygame.image.load("image_file/dark.png")
imgPara = pygame.image.load("image_file/parameter.png")
imgBtlBG = pygame.image.load("image_file/btlbg.png")
imgEnemy = pygame.image.load("image_file/enemy0.png")
imgItem = [
    pygame.image.load("image_file/potion.png"),
    pygame.image.load("image_file/blaze_gem.png"),
    pygame.image.load("image_file/spoiled.png"),
    pygame.image.load("image_file/apple.png"),
    pygame.image.load("image_file/meat.png")
]
imgFloor = [
    pygame.image.load("image_file/floor.png"),
    pygame.image.load("image_file/tbox.png"),
    pygame.image.load("image_file/cocoon.png"),
    pygame.image.load("image_file/stairs.png")
]
imgPlayer = [
    pygame.image.load("image_file/mychr0.png"),
    pygame.image.load("image_file/mychr1.png"),
    pygame.image.load("image_file/mychr2.png"),
    pygame.image.load("image_file/mychr3.png"),
    pygame.image.load("image_file/mychr4.png"),
    pygame.image.load("image_file/mychr5.png"),
    pygame.image.load("image_file/mychr6.png"),
    pygame.image.load("image_file/mychr7.png"),
    pygame.image.load("image_file/mychr8.png")
]
imgEffect = [
    pygame.image.load("image_file/effect_a.png"),
    pygame.image.load("image_file/effect_b.png")
]
...
def init_battle():  # 전투 시작 준비
    ...
    imgEnemy = pygame.image.load("image_file/enemy" + str(typ) + ".png")
...
def main():  # 메인 처리
    ...
    se = [  # 효과음 및 징글
        pygame.mixer.Sound("sound_file/ohd_se_attack.ogg"),
        pygame.mixer.Sound("sound_file/ohd_se_blaze.ogg"),
        pygame.mixer.Sound("sound_file/ohd_se_potion.ogg"),
        pygame.mixer.Sound("sound_file/ohd_jin_gameover.ogg"),
        pygame.mixer.Sound("sound_file/ohd_jin_levup.ogg"),
        pygame.mixer.Sound("sound_file/ohd_jin_win.ogg")
    ]
    ...
    while True:
        ...
        if idx == 0:  # 타이틀 화면
            if tmr == 1:
                pygame.mixer.music.load("sound_file/ohd_bgm_title.ogg")
            ...
            if key[K_SPACE] == 1:
                ...
                blazegem = 0
                idx = 1
                pygame.mixer.music.load("sound_file/ohd_bgm_field.ogg")
                pygame.mixer.music.play(-1)
            ...
            if tmr == 1:
                pygame.mixer.music.load("sound_file/ohd_bgm_battle.ogg")
                pygame.mixer.music.play(-1)
                init_battle()
                init_message()
            elif tmr <= 4:
