...
imgFloor = pygame.image.load("image_file/floor.png")
imgPlayer = pygame.image.load("image_file/player.png")
...
def main():
    ...
    screen = pygame.display.set_mode((176, 176), pygame.SCALED | pygame.RESIZABLE)
